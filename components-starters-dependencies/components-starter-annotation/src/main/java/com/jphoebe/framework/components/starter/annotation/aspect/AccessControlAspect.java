...
import com.jphoebe.framework.components.starter.annotation.AccessControl;
import com.jphoebe.framework.components.starter.annotation.config.AccessControlConfig;
import com.jphoebe.framework.components.starter.annotation.exception.ControllerDeprecatedException;
...
public class AccessControlAspect {
    ...
    @Pointcut("@annotation(com.jphoebe.framework.components.starter.annotation.AccessControl)")
