package cn.auntec.framework.components.util.entity;

import cn.auntec.framework.components.core.common.serializable.SerializableBean;
import cn.auntec.framework.components.util.entity.value.PropertiesValueList;
import cn.auntec.framework.components.util.entity.value.PropertiesValueStr;
import lombok.*;
