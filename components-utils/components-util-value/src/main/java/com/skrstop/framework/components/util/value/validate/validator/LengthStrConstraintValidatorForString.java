 ...
 */
public class LengthStrConstraintValidatorForString implements ConstraintValidator<LengthSize, String> {
    ...
    public boolean isValid(String value, ConstraintValidatorContext context) {
        ...
        String test = ObjectUtil.isNull(value) ? StringPoolConst.EMPTY : value;
        if (size) {
