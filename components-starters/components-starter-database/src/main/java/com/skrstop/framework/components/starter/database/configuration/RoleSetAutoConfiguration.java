...
public class RoleSetAutoConfiguration {
    ...
    @Bean
    @Role(BeanDefinition.ROLE_INFRASTRUCTURE)
    public static BeanDefinitionRegistryPostProcessor databaseStarterPropertiesRoleSet() {
        return registry -> {
            String dynamicRedisPropertiesBeanName = GlobalConfigConst.DATABASE_DYNAMIC + "-" + DynamicDataSourceProperties.class.getName();
