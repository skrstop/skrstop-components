...
import cn.auntec.framework.components.starter.annotation.AccessLimit;
import cn.auntec.framework.components.starter.annotation.exception.AccessLimitException;
import cn.auntec.framework.components.starter.annotation.utils.MethodUtil;
...
public class AccessLimitAspect {
    ...
    /*** 限流 */
    @Pointcut("@annotation(cn.auntec.framework.components.starter.annotation.AccessLimit)")
