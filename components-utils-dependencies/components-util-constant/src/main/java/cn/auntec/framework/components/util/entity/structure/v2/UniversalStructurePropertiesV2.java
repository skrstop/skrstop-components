...
import cn.auntec.framework.components.util.entity.structure.v2.value.PropertiesValueListV2;
import cn.auntec.framework.components.util.entity.structure.v2.value.PropertiesValueObjV2;
import cn.auntec.framework.components.util.entity.structure.v2.value.PropertiesValueStrV2;
import lombok.*;
...
public class UniversalStructurePropertiesV2 extends SerializableBean {
    ...
    /**
     * 数据值类型
     * {@link cn.auntec.framework.components.util.constant.DataInputTypeConst}
     */
