...
public class StrUtil extends cn.hutool.core.util.StrUtil {
    ...
    public static String join(Collection<?> coll) {
        return StrUtil.collectionToCommaDelimitedString(coll);
    }
    ...
    public static String join(Collection<?> coll, String delim) {
        return StrUtil.collectionToDelimitedString(coll, delim);
    }
    ...
    public static String join(Object[] arr) {
        return StrUtil.arrayToCommaDelimitedString(arr);
    }
    ...
    public static String join(Object[] arr, String delim) {
        return StrUtil.arrayToDelimitedString(arr, delim);
    }
    ...
    public static String randomUUID() {
        ...
        return new UUID(random.nextLong(), random.nextLong()).toString().replace(StringPoolConst.DASH, StringPoolConst.EMPTY);
    }
     ...
     * @return 格式化后的文本
     */
    public static String format(CharSequence template, String... params) {
        if (null == template) {
            return null;
        }
    ...
    public static String format(CharSequence template, Map<?, ?> map) {
        ...
        for (Map.Entry<?, ?> entry : map.entrySet()) {
            template2 = template2.replace("{" + entry.getKey() + "}", entry.getValue().toString());
        }
        return template2;
    }
    ...
    public static String getContainsStr(CharSequence str, CharSequence... testStrs) {
        if (StrUtil.isEmpty(str) || ObjectUtil.isEmpty(testStrs)) {
            return null;
        }
    ...
    public static String lowerFirst(String str) {
        ...
        if (firstChar >= StringPoolConst.U_A && firstChar <= StringPoolConst.U_Z) {
            char[] arr = str.toCharArray();
            arr[0] += (StringPoolConst.L_A - StringPoolConst.U_A);
    ...
    public static String upperFirst(String str) {
        char firstChar = str.charAt(0);
        if (firstChar >= StringPoolConst.L_A && firstChar <= StringPoolConst.L_Z) {
            char[] arr = str.toCharArray();
            arr[0] -= (StringPoolConst.L_A - StringPoolConst.U_A);
            return new String(arr);
        }
    ...
    public static Collection<String> sortAscll(List<String> list) {
        return sortAscll(list, false);
    }
     ...
     * @return
     */
    public static Collection<String> sortAscll(List<String> list, boolean desc) {
