...
import com.skrstop.framework.components.util.compression.bean.BinaryFile;
import com.skrstop.framework.components.util.compression.bean.CompressionLevel;
import com.skrstop.framework.components.util.compression.bean.CompressionType;
import com.skrstop.framework.components.util.compression.utils.CompressLoggerKits;
import com.skrstop.framework.components.util.compression.utils.Constants.FILE_TYPES_ALLOW;
import com.skrstop.framework.components.util.compression.utils.Constants.SOURCE;
