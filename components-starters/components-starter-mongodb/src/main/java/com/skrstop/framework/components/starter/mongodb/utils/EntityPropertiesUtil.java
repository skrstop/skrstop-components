...
public class EntityPropertiesUtil {
    ...
    public static Class<?> getColumnTypeId(Map<Class<?>, Map<String, Class<?>>> propertyFieldCache) {
        Map<String, Class<?>> idColumnMap = propertyFieldCache.get(PropertyId.class);
        ...
        return idColumnMap.values().stream().findFirst().orElse(null);
    }
     ...
     * @return
     */
    public static Map<Class<?>, Map<String, Class<?>>> tableProperties(String propertyNaming, Class<?> entityClass) {
