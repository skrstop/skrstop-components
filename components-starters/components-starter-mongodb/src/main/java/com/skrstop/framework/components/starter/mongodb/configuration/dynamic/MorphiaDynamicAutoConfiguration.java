...
public class MorphiaDynamicAutoConfiguration {
    ...
    public MongoClient mongo(DynamicMongodbProperties dynamicMongodbProperties, Environment environment) {
        return new DynamicMongoClient(dynamicMongodbProperties, environment);
    }
