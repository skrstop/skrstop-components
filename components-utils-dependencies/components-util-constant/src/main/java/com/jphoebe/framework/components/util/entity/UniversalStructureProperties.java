...
import com.jphoebe.framework.components.util.entity.value.PropertiesValueList;
import com.jphoebe.framework.components.util.entity.value.PropertiesValueStr;
import lombok.*;
