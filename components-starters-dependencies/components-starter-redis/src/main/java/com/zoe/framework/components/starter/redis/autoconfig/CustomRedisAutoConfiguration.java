package com.zoe.framework.components.starter.redis.autoconfig;

import com.zoe.framework.components.starter.redis.config.FastJsonRedisTemplate;
import com.zoe.framework.components.starter.redis.config.GlobalRedisConfig;
