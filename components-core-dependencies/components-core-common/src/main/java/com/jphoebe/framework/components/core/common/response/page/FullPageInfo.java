package com.jphoebe.framework.components.core.common.response.page;

import com.jphoebe.framework.components.core.common.response.abstracts.AbstractPageInfo;
