...
import com.zoe.framework.components.util.media.image.ImageUtil;
...
import static com.zoe.framework.components.util.constant.ImageTypeConst.JPG_FORMAT_NAME;
...
public class ImageUtilTest {
    ...
    public void test() throws IOException {
        File file = new File("/Users/zoe/test/abcdefg.png");
        File out = new File("/Users/zoe/test/test.jpg");
