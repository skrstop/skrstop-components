...
public class VideoUtilTest {
    ...
    @Ignore
    public void test() {
        File file = new File("/Users/skrstop/Downloads/1.mp4");
        File out = new File("/Users/skrstop/Downloads/11.gif");
        long start = System.currentTimeMillis();
        com.skrstop.framework.components.util.media.video.VideoUtil.Builder.ofFile(file)
