package com.jphoebe.framework.components.starter.mongodb.service.impl;

import cn.hutool.core.util.IdUtil;
import cn.hutool.core.util.ReflectUtil;
import com.jphoebe.framework.components.core.common.response.page.CommonPageData;
import com.jphoebe.framework.components.core.common.response.page.SimplePageInfo;
...
import com.jphoebe.framework.components.starter.mongodb.entity.*;
import com.jphoebe.framework.components.starter.mongodb.entity.expand.CreatorExpand;
import com.jphoebe.framework.components.starter.mongodb.entity.expand.UpdaterExpand;
import com.jphoebe.framework.components.starter.mongodb.entity.version.*;
import com.jphoebe.framework.components.starter.mongodb.service.SuperService;
import com.jphoebe.framework.components.starter.mongodb.wrapper.PageQuery;
...
import com.jphoebe.framework.components.util.value.format.TextFormatUtil;
...
public abstract class SuperServiceImpl<T extends AbstractBaseEntity> implements SuperService<T> {
    ...
    @Autowired
    private GlobalMongodbConfig globalMongodbConfig;
    ...
    private void initPropertiesFormat() {
        if (!globalMongodbConfig.getUnderlineProperties()) {
