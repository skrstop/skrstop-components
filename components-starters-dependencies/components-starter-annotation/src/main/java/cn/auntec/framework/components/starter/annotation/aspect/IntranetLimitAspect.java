...
import cn.auntec.framework.components.starter.annotation.exception.IntranetLimitException;
...
public class IntranetLimitAspect {
    ...
    @Pointcut("@annotation(cn.auntec.framework.components.starter.annotation.IntranetLimit)")
