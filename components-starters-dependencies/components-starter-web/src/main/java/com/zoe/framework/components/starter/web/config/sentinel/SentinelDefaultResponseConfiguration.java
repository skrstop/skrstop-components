package com.zoe.framework.components.starter.web.config.sentinel;

import com.alibaba.csp.sentinel.adapter.spring.webflux.callback.BlockRequestHandler;
import com.alibaba.csp.sentinel.adapter.spring.webmvc.callback.BlockExceptionHandler;
import com.alibaba.csp.sentinel.annotation.SentinelResource;
import com.zoe.framework.components.starter.web.config.sentinel.webflux.DefaultWebFluxBlockRequestHandler;
import com.zoe.framework.components.starter.web.config.sentinel.webmvc.DefaultWebMvcBlockExceptionHandler;
