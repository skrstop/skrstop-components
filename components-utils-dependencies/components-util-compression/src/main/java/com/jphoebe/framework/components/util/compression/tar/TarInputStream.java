...
public class TarInputStream extends FilterInputStream {
    ...
    /**
     * Checks if the bytes being read exceed the entry size and adjusts the byte array length. Updates
     * the byte counters
     *
    ...
    /**
     * Returns the current offset (in bytes) from the beginning of the stream. This can be used to
     * find out at which point in a tar file an entry's content begins, for instance.
     */
