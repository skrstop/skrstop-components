package cn.auntec.framework.components.starter.web.config.sentinel;

import cn.auntec.framework.components.starter.web.config.sentinel.webflux.DefaultWebFluxBlockRequestHandler;
import cn.auntec.framework.components.starter.web.config.sentinel.webmvc.DefaultWebMvcBlockExceptionHandler;
