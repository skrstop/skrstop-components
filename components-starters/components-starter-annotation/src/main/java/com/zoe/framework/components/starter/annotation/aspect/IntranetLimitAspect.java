...
import com.zoe.framework.components.starter.annotation.exception.IntranetLimitException;
...
public class IntranetLimitAspect {
    ...
    @Pointcut("@annotation(com.zoe.framework.components.starter.annotation.IntranetLimit)")
