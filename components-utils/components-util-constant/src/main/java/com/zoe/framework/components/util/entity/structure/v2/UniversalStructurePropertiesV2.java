package com.zoe.framework.components.util.entity.structure.v2;

import com.zoe.framework.components.core.common.serializable.SerializableBean;
import com.zoe.framework.components.util.entity.structure.v2.value.PropertiesValueListV2;
import com.zoe.framework.components.util.entity.structure.v2.value.PropertiesValueObjV2;
import com.zoe.framework.components.util.entity.structure.v2.value.PropertiesValueStrV2;
import lombok.*;
