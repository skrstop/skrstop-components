...
import com.jphoebe.framework.components.util.executor.retry.config.RetryConfigBuilder;
import com.jphoebe.framework.components.util.executor.retry.listener.RetryListener;
...
public class CallExecutorBuilder<T> {
    ...
    public static final RetryConfig DEFAULT_RETRY_CONFIG =
            new RetryConfigBuilder().fixedBackoff5Tries10Sec().build();
