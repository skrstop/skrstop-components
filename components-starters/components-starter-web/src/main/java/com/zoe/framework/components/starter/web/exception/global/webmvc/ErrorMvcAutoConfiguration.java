...
//        this.serverProperties.getError().isIncludeException();
    ...
    @ConditionalOnMissingBean(value = DefaultErrorController.class,
            search = SearchStrategy.CURRENT)
    @ConditionalOnProperty(value = "zoe.exception.config.has-html-error", havingValue = "false", matchIfMissing = true)
    ...
    @ConditionalOnMissingBean(value = DefaultErrorController.class,
            search = SearchStrategy.CURRENT)
    @ConditionalOnProperty(value = "zoe.exception.config.has-html-error", havingValue = "true", matchIfMissing = false)
