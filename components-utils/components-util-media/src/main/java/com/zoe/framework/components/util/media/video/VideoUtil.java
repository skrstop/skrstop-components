package com.zoe.framework.components.util.media.video;

import cn.hutool.core.img.gif.AnimatedGifEncoder;
import cn.hutool.core.io.FileUtil;
import cn.hutool.core.util.IdUtil;
import com.zoe.framework.components.util.constant.ImageTypeConst;
import com.zoe.framework.components.util.constant.VideoTypeConst;
import com.zoe.framework.components.util.media.exception.image.ImageHandleException;
import com.zoe.framework.components.util.media.exception.video.VideoHandleException;
import com.zoe.framework.components.util.value.data.ObjectUtil;
import com.zoe.framework.components.util.value.data.StrUtil;
import com.zoe.framework.components.util.value.stream.StreamUtil;
