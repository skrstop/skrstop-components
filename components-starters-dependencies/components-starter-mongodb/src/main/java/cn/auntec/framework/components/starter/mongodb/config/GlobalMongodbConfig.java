package cn.auntec.framework.components.starter.mongodb.config;

import cn.auntec.framework.components.starter.mongodb.constant.GlobalConfigConst;
...
public class GlobalMongodbConfig {
    ...
    public GlobalMongodbConfig() {
        this.mapPackage = "cn.auntec.business";
