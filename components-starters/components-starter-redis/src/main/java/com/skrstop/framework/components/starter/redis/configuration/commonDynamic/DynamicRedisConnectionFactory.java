...
import com.skrstop.framework.components.starter.redis.configuration.commonDynamic.builder.JedisConnectionConfiguration;
import com.skrstop.framework.components.starter.redis.configuration.commonDynamic.builder.LettuceConnectionConfiguration;
import com.skrstop.framework.components.starter.redis.configuration.commonDynamic.builder.PropertiesRedisConnectionDetails;
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        dynamicRedisProperties.getDataSources().forEach((key, redisProperties) -> {
            ...
            if (RedisProperties.ClientType.LETTUCE.equals(type)) {
                ...
                LettuceConnectionFactory lettuceConnectionFactory = new LettuceConnectionConfiguration(redisProperties
                ...
                JedisConnectionFactory jedisConnectionFactory = new JedisConnectionConfiguration(redisProperties
                        , new PropertiesRedisConnectionDetails(redisProperties)
                        , standaloneConfigurationProvider
                        , sentinelConfiguration
                        , clusterConfiguration
