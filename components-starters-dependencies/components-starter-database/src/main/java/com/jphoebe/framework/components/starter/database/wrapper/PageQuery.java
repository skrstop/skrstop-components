package com.jphoebe.framework.components.starter.database.wrapper;

import com.baomidou.mybatisplus.core.metadata.OrderItem;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.jphoebe.framework.components.core.common.request.ClientPageQuery;
import com.jphoebe.framework.components.starter.database.entity.AbstractTimeBaseEntity;
import com.jphoebe.framework.components.util.value.data.ArrayUtil;
import com.jphoebe.framework.components.util.value.lambda.LambdaUtil;
