...
public class DynamicRedisServiceImpl implements DynamicRedisService {
    ...
    @Override
    public Long zsetUnionAndStore(String dsKey, String key, Collection<String> otherKeys, String destKey, Aggregate aggregate, Weights weights) {
    ...
    @Override
    public Long zsetIntersectAndStore(String dsKey, String key, Collection<String> otherKeys, String destKey, Aggregate aggregate, Weights weights) {
        return this.redisService.zsetIntersectAndStore(key, otherKeys, destKey, aggregate, weights);
    }

    @Override
    public <T> Set<T> zsetRangeByLex(String dsKey, String key, Range<String> range, Class<T> cls) {
        return this.redisService.zsetRangeByLex(key, range, cls);
    }

    @Override
    public <T> Set<T> zsetRangeByLex(String dsKey, String key, Range<String> range, Limit limit, Class<T> cls) {
