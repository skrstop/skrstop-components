...
public class ProtostuffUtil {
     ...
     * schema缓存
     */
    static Map<Class<?>, Schema<?>> SCHEMA_CACHED = new ConcurrentHashMap<>();

    /**
     * 序列化/反序列化包装类 Schema 对象
     */
    static final Schema<SerializeDeserializeWrapper> WRAPPER_SCHEMA = ProtostuffUtil.getSchema(SerializeDeserializeWrapper.class);
