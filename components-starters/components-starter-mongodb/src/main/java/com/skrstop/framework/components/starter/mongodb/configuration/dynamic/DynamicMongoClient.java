...
public class DynamicMongoClient implements MongoClient {
    ...
    public DynamicMongoClient(DynamicMongodbProperties dynamicMongodbProperties, Environment environment) {
        ...
        dataSources.forEach((key, value) -> {
            ...
            List<MongoClientSettingsBuilderCustomizer> builderCustomizers = CollectionUtil.newArrayList(new MongoPropertiesClientSettingsBuilderCustomizer(value, environment));
