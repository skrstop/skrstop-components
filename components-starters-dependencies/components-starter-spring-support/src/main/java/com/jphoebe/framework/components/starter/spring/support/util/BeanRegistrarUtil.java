 ...
 */
package com.jphoebe.framework.components.starter.spring.support.util;
...
public abstract class BeanRegistrarUtil {
    ...
    public static boolean registerInfrastructureBean(
        ...
        if (!beanDefinitionRegistry.containsBeanDefinition(beanName)) {
            ...
            log.info("The Infrastructure bean definition [{} with name [{}] has been registered.", beanDefinition, beanName);
        }
