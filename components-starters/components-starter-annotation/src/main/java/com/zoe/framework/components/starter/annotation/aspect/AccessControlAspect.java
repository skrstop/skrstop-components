...
import com.zoe.framework.components.starter.annotation.config.AccessControlConfig;
...
public class AccessControlAspect {
    ...
    @Pointcut("@annotation(com.zoe.framework.components.starter.annotation.AccessControl)")
