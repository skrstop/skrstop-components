 ...
 */
public interface FallbackFactory<T> extends org.springframework.cloud.openfeign.FallbackFactory<T> {
    ...
    final class Default<T> implements FallbackFactory<T> {
        ...
        public Default(T constant) {
            this(constant, Logger.getLogger(FallbackFactory.Default.class.getName()));
        }
