...
import com.jphoebe.framework.components.starter.annotation.ServiceLock;
...
public class ServiceLockAspect {
    ...
    /*** Service层切点 */
    @Pointcut("@annotation(com.jphoebe.framework.components.starter.annotation.ServiceLock)")
