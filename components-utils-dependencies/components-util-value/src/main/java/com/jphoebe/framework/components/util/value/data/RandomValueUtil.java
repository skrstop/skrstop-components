...
public class RandomValueUtil {
     ...
     * @return
     */
    private static String randomStr(int length, String charStr) {
        if (length <= 0) {
            return "";
        }
    ...
    public static String getRandom(int length) {
        return randomStr(length, ALLCHAR);
    }
    ...
    public static String getStr(int length) {
        return randomStr(length, LETTERCHAR);
    }
    ...
    public static String getNum(int length) {
        return randomStr(length, NUMBERCHAR);
    }
