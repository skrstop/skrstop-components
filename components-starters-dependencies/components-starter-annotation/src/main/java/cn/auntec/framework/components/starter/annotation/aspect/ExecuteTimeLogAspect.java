...
import cn.auntec.framework.components.starter.annotation.ExecuteTimeLog;
...
public class ExecuteTimeLogAspect {
    ...
    /*** 执行耗时 */
    @Pointcut("@annotation(cn.auntec.framework.components.starter.annotation.ExecuteTimeLog)")
