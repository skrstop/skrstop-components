package com.jphoebe.framework.components.util.system.process;
...
import com.jphoebe.framework.components.util.event.core.Callback;
import com.jphoebe.framework.components.util.event.core.CallbackResult;
        ...
        Future<ProcessResult> resultFuture = ThreadPoolUtil.execAsync(() -> {
            ...
            try {
                ...
                if (i != 0) {
                    ...
                    log.error(error);
                    throw new AuntecRuntimeException(error);
                }
            } catch (Throwable e) {
