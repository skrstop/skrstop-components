...
import com.zoe.framework.components.starter.annotation.PrivacyInfo;
import com.zoe.framework.components.starter.annotation.PrivacyInfoValue;
...
public class PrivacyInfoAspect {
    ...
    @Pointcut("@annotation(com.zoe.framework.components.starter.annotation.PrivacyInfo)")
