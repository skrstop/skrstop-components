...
public interface DynamicRedisService {
    ...
    default Long zsetUnionAndStore(final String dsKey, String key, Collection<String> otherKeys, String destKey, RedisZSetCommands.Aggregate aggregate) {
        return zsetUnionAndStore(dsKey, key, otherKeys, destKey, aggregate, RedisZSetCommands.Weights.fromSetCount(1 + otherKeys.size()));
    }

    Long zsetUnionAndStore(final String dsKey, String key, Collection<String> otherKeys, String destKey, RedisZSetCommands.Aggregate aggregate, RedisZSetCommands.Weights weights);
    ...
    default Long zsetIntersectAndStore(final String dsKey, String key, Collection<String> otherKeys, String destKey, RedisZSetCommands.Aggregate aggregate) {
        return zsetIntersectAndStore(dsKey, key, otherKeys, destKey, aggregate, RedisZSetCommands.Weights.fromSetCount(1 + otherKeys.size()));
    }

    Long zsetIntersectAndStore(final String dsKey, String key, Collection<String> otherKeys, String destKey, RedisZSetCommands.Aggregate aggregate, RedisZSetCommands.Weights weights);

    <T> Set<T> zsetRangeByLex(final String dsKey, String key, RedisZSetCommands.Range range, Class<T> cls);

    <T> Set<T> zsetRangeByLex(final String dsKey, String key, RedisZSetCommands.Range range, RedisZSetCommands.Limit limit, Class<T> cls);
