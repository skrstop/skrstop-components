package com.skrstop.framework.components.starter.portShift.configuration;

import com.skrstop.framework.components.util.constant.StringPoolConst;
import com.skrstop.framework.components.util.system.net.PortUtil;
    ...
    public WebServerFactoryCustomizer<ConfigurableWebServerFactory> webServerFactoryCustomizer(
        ...
        return factory -> {
            ...
            if (serverSocketFromBasePort != basePort) {
                log.info("[skrstop] Port shift from {} to {}", basePort, serverSocketFromBasePort);
            }
