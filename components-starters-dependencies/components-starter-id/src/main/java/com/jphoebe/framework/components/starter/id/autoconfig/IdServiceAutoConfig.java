package com.jphoebe.framework.components.starter.id.autoconfig;

import com.jphoebe.framework.components.starter.id.config.GlobalIdConfig;
import com.jphoebe.framework.components.starter.id.constant.GenerateTypeConst;
import com.jphoebe.framework.components.starter.id.service.IdGenerationService;
import com.jphoebe.framework.components.starter.id.service.strategy.LocalIdGenerationServiceImpl;
