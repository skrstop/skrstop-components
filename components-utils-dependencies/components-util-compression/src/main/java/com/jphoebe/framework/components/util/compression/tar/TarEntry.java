...
public class TarEntry {
     ...
     *
     * <p>This method is useful to add new entries programmatically (e.g. for adding files or
     * directories that do not exist in the file system).
     */
    ...
    /**
     * Checks if the org.kamra.jtar entry is a directory
     */
