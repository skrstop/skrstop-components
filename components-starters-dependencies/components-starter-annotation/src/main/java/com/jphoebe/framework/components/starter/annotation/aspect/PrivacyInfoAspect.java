...
import com.jphoebe.framework.components.starter.annotation.PrivacyInfo;
import com.jphoebe.framework.components.starter.annotation.PrivacyInfoValue;
...
public class PrivacyInfoAspect {
    ...
    @Pointcut("@annotation(com.jphoebe.framework.components.starter.annotation.PrivacyInfo)")
