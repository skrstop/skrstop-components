package com.skrstop.framework.components.util.db.redis.jedis;
...
public class JedisUtil implements Closeable {
     ...
     * @return {@link RedisDS}
     */
    public static RedisDS create(Setting setting) {
     ...
     * @param group   配置文件中配置分组
     */
    public JedisUtil(Setting setting, String group) {
     ...
     * @return this
     */
    public JedisUtil init(String group) {
        if (null == setting) {
        ...
        this.pool = new JedisPool(config,
                ...
                // 客户端名
                setting.getStr("clientName", group, "skrstop"),
                // 是否使用SSL
