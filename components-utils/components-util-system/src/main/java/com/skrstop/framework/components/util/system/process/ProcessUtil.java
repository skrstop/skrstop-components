package com.skrstop.framework.components.util.system.process;
...
import com.skrstop.framework.components.util.event.core.CallbackResult;
        ...
        Future<ProcessResult> resultFuture = ThreadPoolUtil.execAsync(() -> {
            ...
            try {
                ...
                if (i != 0) {
                    ...
                    log.error(error);
                    throw new SkrstopRuntimeException(error);
                }
            } catch (Throwable e) {
